...
`@Configuration` annotation is used to indicate that a class declares one or more @Bean methods, and may be processed by the Spring container to generate bean definitions and service requests for those beans at runtime
## D
## E
`@Entity`
## F
